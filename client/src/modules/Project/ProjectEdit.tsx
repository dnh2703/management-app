...
const ProjectEdit = () => {
  ...
  return (
    <>
      <div className={`bg-white px-6 pb-8 rounded-lg shadow relative ${projectQuery.isLoading && 'animate-pulse'}`}>
        <div className='pt-8'>
          {owner ? (
            <Button
            ...
            >
              ...
              <span className=''>-</span>
              <span className='font-bold'>{owner.customer_id}</span>
            </Button>
          ) : (
            <Button className='bg-gray-50 cursor-auto'> No owner </Button>
          )}
        </div>
