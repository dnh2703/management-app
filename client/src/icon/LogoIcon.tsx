...
import { SVGProps } from '~/components/Spinner'

const LogoIcon = ({ className, ...props }: SVGProps) => {
  return (
    <div className='flex text-zinc-950 gap-2 items-center cursor-pointer'>
      <svg
      ...
      <h3 className='font-semibold text-lg'>Project M.</h3>
    </div>
  )
}
